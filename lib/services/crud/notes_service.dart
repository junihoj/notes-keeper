...
import 'package:test_project/extensions/list/filter.dart';
import 'package:test_project/services/crud/crud_exceptions.dart';
...
class NotesService {
  ...
  Future<DatabaseNote> createNote({required DatabaseUser owner}) async {
    ...
    final note = DatabaseNote(
        id: noteId, text: text, isSyncedWithCloud: true, userId: owner.id);
    _notes.add(note);
    _notesStreamController.add(_notes);
    return note;
  }
