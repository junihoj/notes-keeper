...
import 'package:test_project/services/auth/auth_provider.dart';
...
void main() {
  group('Mock Authentication', () {
    ...
    test('should be able to be initialsize', () async {
    ...
    test('login user should be able to to get verified', () {
